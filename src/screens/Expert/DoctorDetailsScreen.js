      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        {!doctor ? (
          <View style={styles.noDataContainer}>
            ...
            <Button mt="2" colorScheme="indigo" onPress={handleViewProfile}>
            View Profile
          </Button>
          </View>
        ) : (
          <>
            ...
            <View style={styles.middleContainer}>
              ...
              <View style={styles.box}>
                <View style={styles.experienceContainer}>
                  <Ionicons name="hourglass" size={30} color="#636e72" />
              ...
              <View style={styles.box}>
                <View style={styles.educationContainer}>
                  <Ionicons name="podium" size={30} color="#130f40" />
              ...
              <View style={styles.box}>
                <View style={styles.languagesContainer}>
                  <Ionicons name="id-card" size={30} color="#4834d4" />
            ...
            <Button mt="2" colorScheme="indigo" onPress={handleBooking}>
                Make An Appointment
            </Button>
          </>
        )}
